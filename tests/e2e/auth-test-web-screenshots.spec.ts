/**
 * Authentication Test with Web Screenshots - MySchool Application
 * 
...
test.describe('Authentication Flow with Web Screenshots', () => {
  test('Successful Admin Login with UI Verification', async ({ page }) => {
    ...
    await captureScreenshot(page, '03_login_form_filled_admin', 'Login form filled with admin credentials');
  ...
  test('Successful User Login with UI Verification', async ({ page }) => {
    ...
    await captureScreenshot(page, '06_login_form_filled_user', 'Login form filled with user credentials');
